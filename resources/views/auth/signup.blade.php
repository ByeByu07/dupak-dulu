                    ...
                    <div class="row">
                        <div class="mb-3 col-lg-12">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror" type="email" name="email" id="email"  aria-describedby="email" value="{{old('email')}}">
                            </div>
                        </div>
                        <div class="mb-3 col-lg-12">
                            <label for="wa" class="form-label">No WhatsApp ( opsional )</label>
                            <div class="input-group">
                                <span class="input-group-text" id="wa">@</span>
                                <input class="form-control" type="wa" name="wa" id="wa"  aria-describedby="wa" value="{{old('wa')}}">
                            </div>
                        </div>
