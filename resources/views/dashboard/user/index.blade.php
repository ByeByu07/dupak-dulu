...
@section('content')
    <div class="row">
        <div class="col-lg-4">
            <div class="card bg-warning border-0 align-items-center">
                <div class="card-body">
                    ...
                    <div class="">085710910867</div>
                        {{-- <div class="row mt-4 ">
                        <div class="col-4">
                            <div width="50" height="50" class="p-1">
                        ...
                        <div class="col-4">
                            <div width="50" height="50" class="p-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-chat-right-quote" viewBox="0 0 16 16">
                        ...
                        <div class="col-4">
                            <div width="50" height="50" class="align-items-center p-1 justify-content-center">
                    ...
                    {{-- <div class="row my-3">
                        <img width="400" height="260" class="bg-dark shadow-lg img-fluid"/>
                    </div> --}}
            </div>
        </div>
        <div class="col-lg-8">
